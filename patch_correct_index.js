...
// 3. Bottom nav completely hidden
ci = ci.replace('.bottom-nav{\n  display:none;', '.bottom-nav{\n  display:none !important;');
ci = ci.replace('<div class="bottom-nav" id="bottom-nav">', '<div class="bottom-nav" id="bottom-nav" style="display:none !important;">');
ci = ci.replace(/var bn = document\.getElementById\('bottom-nav'\);[\s\S]*?\}/, '/* bottom nav logic removed */');

// 4. Global popup patch
...
console.log('Applied patches successfully to new index.html!');
